...
namespace Oxide.Plugins
{
    ...
    public class InfoPanel : RustPlugin
    {
        ...
        void OnPlayerInit(BasePlayer player)
        {
            ...
            //Ha player connection alatt kickelve volt akkor nem hat rÃ¡ az onDisconnect, ezÃ©rt itt is ellenÅrizni kell....
        ...
        #region PanelLoad
        /// <summary>
        /// Panelek betÃ¶ltÃ©se egy adott jÃ¡tÃ©kosnak.
        /// </summary>
        ...
        public class Compass
        {
            ...
            public string GetDirection(string PlayerID)
            {
                ...
                string str = $"{PCurrent.y.ToString("0")}Â°";
        ...
        public class IPanel
        {
            ...
            {
                // ElÅzÅ testvÃ©rek ugyan azzal az anchorX-el
        ...
        private bool PanelRegister(string PluginName,string PanelName, string json)
        {
            ...
            //Ha a plugin panelja mÃ©g nem volt bejegyezve
